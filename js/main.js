...
import { MonteCarloFeature } from './features/montecarlo.js';
...
class ROICalculatorApp {
    ...
    async initializeFeatures() {
        ...
        this.features = {
            ...
            saved: new SavedFeature(this.state, this.dataService),
            export: new ExportFeature(this.state, this.chartManager)
        };
...
// Also use window load as fallback
...
async function initializeApp() {
    if (!window.roiCalculatorApp) {
        console.log('Creating and initializing ROI Calculator App...');
